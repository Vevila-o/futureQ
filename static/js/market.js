...
const STAGES_CONFIG = [
  {
    ...
    announceTitle: '遊戲開始！',
    announceDesc:  '請依照「種類」\n將食材放入對應的籃子！',
    baskets: RULE_BASKETS.kind, totalQ: 10,
    items: [
  ...
  },
  {
    ...
    baskets: RULE_BASKETS.color, totalQ: 10,
    items: [
  ...
  },
  {
    ...
    baskets: RULE_BASKETS.cook, totalQ: 10,
    items: [
      { emoji: '🍎', name: '蘋果',   basket: 0 },
      { emoji: '🍓', name: '草莓',   basket: 0 },
  ...
  },
  {
    ...
    baskets: null, totalQ: 12, items: null,
  },
];
...
function showEndScreen() {
  const total = 42, score = gs.totalScore;
